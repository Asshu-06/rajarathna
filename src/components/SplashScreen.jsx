        ...
        >
          ...
          <div style={{ position: 'relative', width: '100%', maxWidth: '560px', height: 'clamp(140px,28vw,220px)', marginBottom: '20px' }}>
            ...
            <AnimatePresence>
              {(phase === 'curtain' || phase === 'text') && (
                <>
                  <motion.div
                    style={{ position: 'absolute', inset: 0, left: 0, width: '50%', background: 'linear-gradient(to right,#1a0510,#3d0a1e)', transformOrigin: 'left', zIndex: 3 }}
                    initial={{ scaleX: 1 }} animate={{ scaleX: 0 }} transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
                  />
                  <motion.div
                    style={{ position: 'absolute', inset: 0, right: 0, left: '50%', background: 'linear-gradient(to left,#1a0510,#3d0a1e)', transformOrigin: 'right', zIndex: 3 }}
                    initial={{ scaleX: 1 }} animate={{ scaleX: 0 }} transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
                  />
                </>
              )}
          ...
          <AnimatePresence>
            {phase === 'text' && (
              ...
              >
                <motion.p
                  style={{ color: '#e8a0b0', fontFamily: 'Lato,sans-serif', fontSize: 'clamp(9px,2vw,11px)', letterSpacing: '0.45em', textTransform: 'uppercase', marginBottom: '14px' }}
                ...
                <motion.h1
                  ...
                  style={{ color: '#f5e6d0', fontSize: 'clamp(1.5rem,5vw,2.8rem)', lineHeight: 1.2 }}
                ...
                <motion.p
                  ...
                  style={{ color: '#e8a0b0', fontSize: 'clamp(0.9rem,2.5vw,1.2rem)', fontStyle: 'italic', marginTop: '10px' }}
